...
namespace PrintFrameSample
{
    ...
    public class WindowMain : System.Windows.Window
    {
        ...
        {
            browserView.Browser.LoadURL("https://docs.oracle.com/javase/7/docs/api/");
        }

        void printButton_Click(object sender, RoutedEventArgs e)
        {
            List<long> framesIds = browserView.Browser.GetFramesIds();
            if (framesIds.Count > 2)
            {
                browserView.Browser.Print(framesIds[2]);
            } 
